...
out vec3 varying_lighting_color;
...
/*** Lighting Calculations ***/
	...
	float specular_contribution = pow( max( dot( reflected_light_direction_view_space.xyz, view_direction_view_space ), 0.0 ), uniform_specular_power ) * uniform_specular_strength;
