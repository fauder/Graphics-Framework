...
out vec4 varying_light_direction_view_space;
...
void main()
{
    ...
    varying_light_direction_view_space = normalize( vec4( uniform_directional_light_data.direction, 0.0 ) * uniform_transform_view );
