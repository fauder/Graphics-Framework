...
namespace ImGuiSetup
{
    ...
    void SetStyle()
    {
        ...
        colors[ ImGuiCol_TabHovered ]                = ImVec4( 1.00f, 1.00f, 1.00f, 0.50f );
        colors[ ImGuiCol_Tab ]                       = ImVec4( 0.10f, 0.10f, 0.10f, 1.00f );
        colors[ ImGuiCol_TabSelected ]               = ImVec4( 0.43f, 0.43f, 0.43f, 0.75f );
        colors[ ImGuiCol_TabSelectedOverline ]       = ImVec4( 1.00f, 0.73f, 0.00f, 0.00f );
        colors[ ImGuiCol_TabDimmed ]                 = ImVec4( 0.06f, 0.06f, 0.06f, 0.75f );
        colors[ ImGuiCol_TabDimmedSelected ]         = ImVec4( 0.33f, 0.33f, 0.33f, 0.75f );
        colors[ ImGuiCol_TabDimmedSelectedOverline ] = ImVec4( 1.00f, 0.00f, 0.00f, 1.00f );
